...
*   **Extremely Lightweight**: Installation package size is controlled at 2-3MB.
*   **Secure & Reliable**: Local encrypted storage, keys are never uploaded.
*   **Simple Operation**: Scan to add, one-click copy, categorized management.
*   **TOTP Standard**: Fully compatible with RFC 6238, supports all major platforms.
